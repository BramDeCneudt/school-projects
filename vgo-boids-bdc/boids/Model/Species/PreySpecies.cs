...
namespace Model.Species
{
    public class PreySpecies : BoidSpecies
    {
        ...
        public static Parameter<string> EnemySpecies1 = new Parameter<string>("Repulsive Species", "controller");
        ...
        private class ArtificialIntelligence : Model.AI.ArtificialIntelligence
        {
            ...
            private readonly IForce enemyForce1;
            ...
            public override Vector2D ComputeAcceleration()
            {
                ...
                total += enemyForce1.Compute(this.self.Bindings, this.world, this.self);
